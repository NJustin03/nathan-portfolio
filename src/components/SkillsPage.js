    ...
    return(
        <Container>
            <div className="IconHolder" style={{paddingBottom: '35%'}}>
                ...
                <img src="https://skillicons.dev/icons?i=c,cpp,cs,java,js,html,css,haskell,py" className='img-fluid d-block' alt="Skill Icons"/>
                <h3 className="Subheading">Libraries/Frameworks</h3>
                <img src="https://skillicons.dev/icons?i=react,bootstrap,express,nodejs" className="img-fluid d-block" alt="Skill Icons"/>
                <h3 className="Subheading">Databases</h3>
                <img src="https://skillicons.dev/icons?i=mysql,mongo,firebase" className="img-fluid d-block" alt="Skill Icons"/>
